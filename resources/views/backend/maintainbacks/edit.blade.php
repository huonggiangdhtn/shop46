                    ...
                    <div class="col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <div class="mt-3 ">
                                ...
                                <input type="number" id='final_amount'  value="{{$mb->final_amount}}"
                                class="form-control py-3 mt-2 " placeholder="Phí vận chuyển">
                            ...
                            <div class="mt-3 ">
                                ...
                                <input type="number" id='paid_amount'  value="{{$mb->paid_amount}}"
                                class="form-control py-3 mt-2 " placeholder="Phí vận chuyển">
...
<script src="{{asset('backend/assets/js/product_mback.js')}}"></script> 
...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc({{$mb->id}},supplier_id, shipcost, bank_id, final_amount,paid_amount);
