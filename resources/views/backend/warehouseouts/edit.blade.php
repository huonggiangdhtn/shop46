                ...
                <div class="intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3">
                                <div class="mt-2">
                                    <div class="form-check form-switch"> <input id="check_paidall" {{$warehouseout->is_paid == true?'checked':''}} class="form-check-input" type="checkbox"> <label class="form-check-label" for="checkbox-switch-7">Đã thanh toán hết</label> </div>
                                </div>
