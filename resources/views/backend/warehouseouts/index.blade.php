                ...
                <tbody>
                    ...
                    <tr class="intro-x ">
                        <td>
                           ...
                           <a  class="tooltip "  title="Xem công nợ"  href="{{route('customer.show',$item->customer_id)}}"> {{\App\Models\User::where('id',$item->customer_id)->value('full_name')}}
                            </a>
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        @if ($item->status == 'active')
                                            ...
                                            <li> 
                                                <form action="{{route('warehouseout.return' )}}" method = "post">
                                                    @csrf
