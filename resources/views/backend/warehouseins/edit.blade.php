                    ...
                    <div class="col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3">
                                ...
                                <input  id='paid_amount' type="number" name='paid_amount' value="{{$warehousein->paid_amount}}"
                                class="form-control py-3 mt-2 " placeholder="số tiền đã thanh toán">
                                <input type='hidden' value="{{$warehousein->final_amount}}" id='totalcost'/>
                            </div>
                            <div class="mt-3">
                                <label style="min-width:50px  " class="form-select-label" for="">
...
$("#discount_amount").keyup(function(){
    ...
    // var discount_amount = document.getElementById('discount_amount').value;
    // iptotalcost.value = tong - discount_amount;
    // var sptotalcost = document.getElementById('sptotalcost');
    // sptotalcost.innerHTML = iptotalcost.value;
    // var check = $('#check_paidall').prop('checked');
    //     if (check == true)
    //     {
    //         // alert($('#totalcost').val());
