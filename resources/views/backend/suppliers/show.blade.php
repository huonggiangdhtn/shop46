            ...
            <div class="lg:flex intro-y box py-5 px-5">
              <div class='relative'> 
                ...
                <div class= "mt-3">
                    ...
                    <br/><span class="form-help"> (-) nhà cung cấp nợ tiền , (+) cửa hàng nợ tiền </span>
                </div>
              </div>
              <div class="mt-3 lg:w-auto   lg:mt-0 ml-auto">
                <a href="{{route('supplier.received',$supplier->id)}}" class="btn btn-primary shadow-md mr-2 primary-btn lg:w-auto   lg:mt-0 ml-auto" > nhận tiền nhà cung cấp </a>
                
                <a href="{{route('supplier.paid',$supplier->id)}}" class="btn btn-primary shadow-md mr-2 primary-btn lg:w-auto   lg:mt-0 ml-auto" > chuyển tiền nhà cung cấp </a>
