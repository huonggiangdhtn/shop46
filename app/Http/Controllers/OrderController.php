...
class OrderController extends Controller
{
    ...
    public function getProductList(Request $request)
    {
        ...
        ->select ('order_details.price','order_details.product_id','order_details.quantity', 'p.title','p.photo','p.id','np.quantity as stock_qty')
    ...
    public function orderOutUpdate(Request $request)
    {
       ...
       $wo->save();
       $detailpros = orderDetail::where('wo_id',$order->id)->get();
